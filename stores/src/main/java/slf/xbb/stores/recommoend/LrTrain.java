...
/**
 * @author ：xbb
 * @date ：Created in 2020/6/23 9:52 上午
 * @description：LR逻辑回归模型训练
 * @modifiedBy：
 * @version:
 */
public class LrTrain {
    public static void main(String[] args) throws IOException {
        ...
        //加载特征及label训练文件
        JavaRDD<String> csvFile = spark.read().textFile("file:///Users/xbb1973/Documents/code/workdir/Search-Recommend-ElasticSearch-Spark/stores/data/feature.csv").toJavaRDD();
        ...
        lrModel.write().overwrite().save("file:///Users/xbb1973/Documents/code/workdir/Search-Recommend-ElasticSearch-Spark/stores/data/lrmode");
        ...
        // 09:55:32.227 [main] INFO org.apache.spark.scheduler.DAGScheduler - Job 5 finished: countByValue at MulticlassMetrics.scala:42, took 0.198881 s
        // auc=0.49809885931558934
